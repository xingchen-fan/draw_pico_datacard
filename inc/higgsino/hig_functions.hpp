...
namespace Higfuncs{
  ...
  extern const NamedFunc eff_higtrig_mettru;
  extern const NamedFunc eff_higtrig_run2_syst_up_mettru;
  extern const NamedFunc eff_higtrig_run2_syst_down_mettru;
