...
#include "higgsino/apply_trigeffs_v1.hpp"

namespace Higfuncs{
const NamedFunc get_0l_trigeff2016_v1("get_0l_trigeff2016_v1", [](const Baby &b) -> NamedFunc::VectorType{
...
const NamedFunc get_0l_fakemet_trigeff2016_v1("get_0l_fakemet_trigeff2016_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_1el_trigeff2016_v1("get_1el_trigeff2016_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
...
const NamedFunc get_1mu_trigeff2016_v1("get_1mu_trigeff2016_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
...
const NamedFunc get_2el_trigeff2016_v1("get_2el_trigeff2016_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
...
const NamedFunc get_2mu_trigeff2016_v1("get_2mu_trigeff2016_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
...
const NamedFunc get_0l_trigeff2017_v1("get_0l_trigeff2017_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_0l_fakemet_trigeff2017_v1("get_0l_fakemet_trigeff2017_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_1el_trigeff2017_v1("get_1el_trigeff2017_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), el_pt = HigUtilities::signal_lepton_pt(b.el_pt(),b.el_sig()), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_1mu_trigeff2017_v1("get_1mu_trigeff2017_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), mu_pt = HigUtilities::signal_lepton_pt(b.mu_pt(),b.mu_sig()), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_2el_trigeff2017_v1("get_2el_trigeff2017_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., el_pt = HigUtilities::signal_lepton_pt(b.el_pt(),b.el_sig());
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_2mu_trigeff2017_v1("get_2mu_trigeff2017_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., mu_pt = HigUtilities::signal_lepton_pt(b.mu_pt(),b.mu_sig());
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_0l_trigeff2018_v1("get_0l_trigeff2018_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_0l_fakemet_trigeff2018_v1("get_0l_fakemet_trigeff2018_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_1el_trigeff2018_v1("get_1el_trigeff2018_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), el_pt = HigUtilities::signal_lepton_pt(b.el_pt(),b.el_sig()), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_1mu_trigeff2018_v1("get_1mu_trigeff2018_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., met = b.met(), mu_pt = HigUtilities::signal_lepton_pt(b.mu_pt(),b.mu_sig()), ht = b.ht();
  errup+=errdown; //suppress unused warning
...
const NamedFunc get_2el_trigeff2018_v1("get_2el_trigeff2018_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., el_pt = HigUtilities::signal_lepton_pt(b.el_pt(),b.el_sig());
  errup+=errdown; //suppress unused warning
  if (el_pt> 40 && el_pt<= 45) {eff = 0.897959; errup = 0.0249664; errdown = 0.0249664;}
...
const NamedFunc get_2mu_trigeff2018_v1("get_2mu_trigeff2018_v1", [](const Baby &b) -> NamedFunc::VectorType{
  float errup=0., errdown=0.; // Not used, but for reference
  float eff = 1., mu_pt = HigUtilities::signal_lepton_pt(b.mu_pt(),b.mu_sig());
  errup+=errdown; //suppress unused warning
