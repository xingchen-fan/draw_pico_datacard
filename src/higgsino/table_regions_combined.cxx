...
int main(int argc, char *argv[]){
  ...
  TableRow("$150 < p_{T}^{\\rm{miss}} \\leq 200$"),
  TableRow("Resolved, 3b", baseline && c_3b+"&&"+hig+"&&"+met_1,0,1, wgt),
  TableRow("Resolved, 4b", baseline && c_4b+"&&"+hig+"&&"+met_1,0,1, wgt),
  TableRow("Boosted, 1H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_singleh+"&&"+met_1,0,1, wgt),
  TableRow("Boosted, 2H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_doubleh+"&&"+met_1,0,1, wgt),
  TableRow("Semi-resolved: resolved-overlap", semi_baseline&&met_1,0,1, wgt),
  TableRow("Semi-resolved: no-overlap", semi_baseline&&!(baseline &&(c_3b || c_4b)&&hig)&&met_1,0,1, wgt),

  TableRow("$200 < p_{T}^{\\rm{miss}} \\leq 300$"),
  TableRow("Resolved, 3b", baseline && c_3b+"&&"+hig+"&&"+met_2,0,1, wgt),
  TableRow("Resolved, 4b", baseline && c_4b+"&&"+hig+"&&"+met_2,0,1, wgt),
  TableRow("Boosted, 1H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_singleh+"&&"+met_2,0,1, wgt),
  TableRow("Boosted, 2H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_doubleh+"&&"+met_2,0,1, wgt),
  TableRow("Semi-resolved: resolved-overlap", semi_baseline&&met_2,0,1, wgt),
  TableRow("Semi-resolved: no-overlap", semi_baseline&&!(baseline &&(c_3b || c_4b)&&hig)&&met_2,0,1, wgt),

  TableRow("$300 < p_{T}^{\\rm{miss}} \\leq 450$"),
  TableRow("Resolved, 3b", baseline && c_3b+"&&"+hig+"&&"+met_3,0,1, wgt),
  TableRow("Resolved, 4b", baseline && c_4b+"&&"+hig+"&&"+met_3,0,1, wgt),
  TableRow("Boosted, 1H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_singleh+"&&"+met_3,0,1, wgt),
  TableRow("Boosted, 2H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_doubleh+"&&"+met_3,0,1, wgt),
  TableRow("Semi-resolved: resolved-overlap", semi_baseline&&met_3,0,1, wgt),
  TableRow("Semi-resolved: no-overlap", semi_baseline&&!(baseline &&(c_3b || c_4b)&&hig)&&met_3,0,1, wgt),

  TableRow("$p_{T}^{\\rm{miss}}>450$"),
  TableRow("Resolved, 3b", baseline && c_3b+"&&"+hig+"&&"+met_4,0,1, wgt),
  TableRow("Resolved, 4b", baseline && c_4b+"&&"+hig+"&&"+met_4,0,1, wgt),
  TableRow("Boosted, 1H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_singleh+"&&"+met_4,0,1, wgt),
  TableRow("Boosted, 2H", boosted_baseline&&boosted_baseline_ak8+"&&"+boosted_doubleh+"&&"+met_4,0,1, wgt),
  TableRow("Semi-resolved: resolved-overlap", semi_baseline&&met_4,0,1, wgt),
  TableRow("Semi-resolved: no-overlap", semi_baseline&&!(baseline &&(c_3b || c_4b)&&hig)&&met_4,0,1, wgt),
