...
int main(int argc, char *argv[]){
  ...
  string production_a = "higgsino_klamath"; string nanoAodFolder_a = string(getenv("LOCAL_PICO_DIR"))+"/net/cms25/cms25r5/pico/NanoAODv7";
  //string production_a = "higgsino_klamath"; string nanoAodFolder_a = "/cms29r0/pico/NanoAODv7";
  ...
  //string production_b = "higgsino_klamath"; string nanoAodFolder_b = string(getenv("LOCAL_PICO_DIR"))+"/net/cms25/cms25r5/pico/NanoAODv7";
  string production_b = "higgsino_klamath"; string nanoAodFolder_b = "/net/cms25/cms25r5/pico/NanoAODv7";
