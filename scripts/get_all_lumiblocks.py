...
def get_runs_and_lumiblocks(nanoaod_filename):
  ...
  nEntries = chain.Draw("run:luminosityBlock","","goff")
...
Finds the run and lumiblock numbers for downloaded NanoAOD files. Saves the data to a pickle file in the OUTPUT_FOLDER. Uses multiple cores.
--------
Example commands:
get_all_lumiblocks.py -n /net/cms25/cms25r0/pico/NanoAODv7/nano -y "2016,2017,2018" -o runs_lumiblocks
get_all_lumiblocks.py -n /net/cms25/cms25r0/pico/NanoAODv7/nano -y 2016 -o runs_lumiblocks/2016
get_all_lumiblocks.py -n /net/cms25/cms25r0/pico/NanoAODv7/nano -y 2017 -o runs_lumiblocks/2017
get_all_lumiblocks.py -n /net/cms25/cms25r0/pico/NanoAODv7/nano -y 2018 -o runs_lumiblocks/2018
''', formatter_class=argparse.RawTextHelpFormatter)
  parser.add_argument('-n', '--nanoaod_base_folder', required=True, default='/net/cms25/cms25r0/pico/NanoAODv7/nano', help='Folder that contains the NanoAOD folders per year')
  ...
  # Options
  #nanoAOD_base_path = '/net/cms25/cms25r0/pico/NanoAODv7/nano'

  #years = [2016, 2017, 2018]
  #years = [2016]
  #output_folder = 'runs_lumiblocks'
  #input_folder = 'runs_lumiblocks'

  #years = [2016]
  #output_folder = 'runs_lumiblocks/2016'
  #input_folder = 'runs_lumiblocks/2016'
  #years = [2017]
  #output_folder = 'runs_lumiblocks/2017'
  #input_folder = 'runs_lumiblocks/2017'
  #years = [2018]
  #output_folder = 'runs_lumiblocks/2018'
  #input_folder = 'runs_lumiblocks/2018'

  nanoAOD_base_path = args.nanoaod_base_folder
  ...
  nanoAOD_filenames = []
  for year in years:
    nanoAOD_path = nanoAOD_base_path + "/" + str(year) + "/data"
    nanoAOD_filenames.extend(glob.glob(nanoAOD_path+"/*.root"))
  ...
  #nanoAOD_filenames = nanoAOD_filenames[:10] # For testing

  # Multiprocess
  pool = multiprocessing.Pool()
  pool_result = pool.map(pool_get_runs_and_lumiblocks, nanoAOD_filenames)
  #print(pool_result)
  # Organize results
  for nanoAOD_filename, runs_lumiblocks in pool_result:
    files_runs_lumiblocks[nanoAOD_filename] = runs_lumiblocks
    dataset_name = get_dataset_name(nanoAOD_filename)
  ...
  #  runs_lumiblocks = get_runs_and_lumiblocks(nanoAOD_filenames[0])
  #  files_runs_lumiblocks[nanoAOD_filename] = runs_lumiblocks
  #  dataset_name = get_dataset_name(nanoAOD_filename)
  #  if dataset_name not in dataset_runs_lumiblocks:
  #    dataset_runs_lumiblocks[dataset_name] = {}
