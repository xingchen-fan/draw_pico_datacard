...
#ra2.Add("/net/cms25/cms25r5/jbkim/ra2b/ra2b_v18f/skim_met150/*root")
ra2.Add("/net/cms25/cms25r5/jbkim/ra2b/ra2b_v18g/skim_met150/*root")
...
cuts = OrderedDict()
cuts["MET>150"] = ["1","1"]
cuts["0 mus"] = ["nvmu==0", "Sum$(Muons.Pt()>10 && abs(Muons.Eta())<2.4 && Muons_mediumID && Muons_iso<0.2)==0"]
#cuts["0 mus"] = ["nvmu==0", "Sum$(Muons.Pt()>10 && abs(Muons.Eta())<2.4 && Muons_mediumID && Muons_MiniIso<0.2)==0"]
cuts["0 els"] = ["nvel==0", "Sum$(Electrons.Pt()>10 && abs(Electrons.Eta())<2.5 && Electrons_iso<0.1)==0"]
...
cuts["0 el trk"] = ["Sum$(abs(tk_pdgid)==11)==0", 
                    ...
                    "Sum$(TAPElectronTracks.Pt()>5 && abs(TAPElectronTracks.Eta())<2.5 && abs(TAPElectronTracks_dxypv)<0.2 && ((TAPElectronTracks.Pt()<25 && TAPElectronTracks_pfRelIso03chg*TAPElectronTracks.Pt()<5) || TAPElectronTracks_pfRelIso03chg<0.2) && TAPElectronTracks_mT<100)==0"]
cuts["0 mu trk"] = ["Sum$(abs(tk_pdgid)==13)==0", 
                    ...
                    "Sum$(TAPMuonTracks.Pt()>5 && abs(TAPMuonTracks.Eta())<2.5 && abs(TAPMuonTracks_dxypv)<0.2  && ((TAPMuonTracks.Pt()<25 && TAPMuonTracks_pfRelIso03chg*TAPMuonTracks.Pt()<5) || TAPMuonTracks_pfRelIso03chg<0.2) && TAPMuonTracks_mT<100)==0"]
cuts["0 pi trk"] = ["Sum$(abs(tk_pdgid)==211)==0", 
                    ...
                    "Sum$(TAPPionTracks.Pt()>10 && abs(TAPPionTracks.Eta())<2.5 && abs(TAPPionTracks_dxypv)<0.2  && ((TAPPionTracks.Pt()<25 && TAPPionTracks_pfRelIso03chg*TAPPionTracks.Pt()<5) || TAPPionTracks_pfRelIso03chg<0.1) && TAPPionTracks_mT<100 && TAPPionTracks_leptonMatch==0)==0"]
