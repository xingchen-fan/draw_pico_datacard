...
int trig_postprocess_plots() {
	//settings
	TFile* f = TFile::Open("ntuples/trig_eff_old_variables_2016_1.root");
	int year = 2016;
	...
	make_efficiency_plot(realmet_num,realmet_den,realmet_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1","Offline E_{T}^{miss}","Efficiency MET[NoMu][110|120]","GeV","realmet");
	//fake met
	...
	make_efficiency_plot(fakemet_num,fakemet_den,fakemet_ratio,string_lumi,"Denom: #it{Jet500}, low #Delta #phi, N_{l veto}=0","Offline E_{T}^{miss}","Efficiency MET[NoMu][110|120]","GeV","fakemet");
	//HT low met
	...
	make_efficiency_plot(htlowmet_num,htlowmet_den,htlowmet_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1, 150 GeV<MET#leq 200 GeV","Offline H_{T}","Efficiency MET[NoMu][110|120]","GeV","htlowmet");
	//HT high met
	...
	make_efficiency_plot(hthighmet_num,hthighmet_den,hthighmet_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1, 200 GeV<MET#leq 300 GeV","Offline H_{T}","Efficiency MET[NoMu][110|120]","GeV","hthighmet");
	//nb
	...
	make_efficiency_plot(nb_num,nb_den,nb_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1, MET > 200 GeV","Offline N_{b}","Efficiency MET[NoMu][110|120]","","nb");
	//nj
	...
	make_efficiency_plot(nj_num,nj_den,nj_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1, MET > 200 GeV","Offline N_{j}","Efficiency MET[NoMu][110|120]","","nj");
	...
	make_efficiency_plot(higcandam_num,higcandam_den,higcandam_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1, MET > 200 GeV","Offline #LT m#GT","Efficiency MET[NoMu][110|120]","GeV","higcandam");
	//Delta R max
	...
	make_efficiency_plot(higcanddrmax_num,higcanddrmax_den,higcanddrmax_ratio,string_lumi,"Denom: "+det_trigger+", N_{j}#geq 3, high #Delta #phi, N_{e}=1, MET > 200 GeV","Offline #Delta R_{max}","Efficiency MET[NoMu][110|120]","","higcanddrmax");
	if (do_controlregions) {
		...
		make_efficiency_plot(elmet_num,elmet_den,elmet_ratio,string_lumi,"Denom: #it{Jet500}, N_{j}#geq 2, N_{e}=1","Offline E_{T}^{miss}","Efficiency [MET[NoMu][110|120]|Ele[Iso27|Iso35|115]]","GeV","elmet");
		//1e pt
		...
		make_efficiency_plot(elpt_num,elpt_den,elpt_ratio,string_lumi,"Denom: #it{Jet500}, N_{j}#geq 2, N_{e}=1, 150 GeV<MET #leq 200 GeV","Offline Electron p_{T}","Efficiency [MET[NoMu][110|120]|Ele[Iso27|Iso35|115]]","GeV","elpt");
		//1mu MET
		...
		make_efficiency_plot(mumet_num,mumet_den,mumet_ratio,string_lumi,"Denom: #it{Jet500}, N_{j}#geq 2, N_{#mu}=1","Offline E_{T}^{miss}","Efficiency [MET[NoMu][110|120]|Mu[Iso24|Iso27|50]]","GeV","mumet");
		//1mu pt
		...
		make_efficiency_plot(mupt_num,mupt_den,mupt_ratio,string_lumi,"Denom: #it{Jet500}, N_{j}#geq 2, N_{#mu}=1, 150 GeV<MET #leq 200 GeV","Offline Muon p_{T}","Efficiency [MET[NoMu][110|120]|Mu[Iso24|Iso27|50]]","GeV","mupt");
		//2e
		...
		make_efficiency_plot(elel_show_num,elel_show_den,elel_show_ratio,string_lumi,"Denom: #it{MET[NoMu][110|120]|Jet500}, N_{j}#geq 2, N_{e}=2, 80 GeV<m_{ee}<100 GeV","Max Offline Electron p_{T}","Efficiency Ele[Iso27|Iso35|115]","GeV","elel_show");
		//2mu
		...
		make_efficiency_plot(mumu_show_num,mumu_show_den,mumu_show_ratio,string_lumi,"Denom: #it{MET[NoMu][110|120]|Jet500}, N_{j}#geq 2, N_{#mu}=2, 80 GeV<m_{#mu#mu}< 100 GeV","Max Offline Muon p_{T}","Efficiency Mu[Iso24|Iso27|50]","GeV","mumu_show");
	}
    	//data (nominal)
